...
- ### 2025/11/22
    ...
    - main.py
- ### 2025/11/15
    - **遭受学业上的巨大挫折以及深刻自省**，更新时得暂停更新了，到寒假再进行更新
  - 微调`qidian.py`和`biquge.py`（2025/10/26）版的下载逻辑

- ### 2025/11/08-09
  - 定义了通用配置逻辑、三种下载器逻辑和小说配置信息细节优化
  - 微调`fanqie.py`（2025/10/26）版的下载逻辑

- ### 2025/11/01
  - **deepseek**成功发力，给予更加规范化的库函数式项目结构，面临新挑战，之前重构结果大致作废
  - 参悟新项目结构中

- ### 2025/10/19 - 2025/10/26
  - 重组`main.py`,使之适配多线程操作
  - 重构`Fanqie.py`,`Qidian.py`和`Biquge.py`，将一类拆分多类以应对不同下载模式
